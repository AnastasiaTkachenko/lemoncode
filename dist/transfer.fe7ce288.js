...
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js"}],"pages/transfer/transfer.custom.validators.js":[function(require,module,exports) {
"use strict";
...
var dayValidator = function dayValidator(_ref) {
  ...
  return {
    succeeded: succeeded,
    message: succeeded ? '' : 'Introduce la fecha correcta'
  };
};
...
var monthValidator = function monthValidator(_ref2) {
  ...
  return {
    succeeded: succeeded,
    message: succeeded ? '' : 'Introduce el mes correcto'
  };
};
exports.monthValidator = monthValidator;
var yearValidator = function yearValidator(_ref3) {
  var value = _ref3.value;
  var succeeded = parseInt(value) >= 0 && parseInt(value) <= 2025;
  return {
    succeeded: succeeded,
    message: succeeded ? '' : 'Introduce el año correcto'
  };
};
...
var _transferCustom = require("./transfer.custom.validators");
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","@lemoncode/fonk-later-date-validator":"../node_modules/@lemoncode/fonk-later-date-validator/dist/@lemoncode/fonk-later-date-validator.esm.js","./transfer.custom.validators":"pages/transfer/transfer.custom.validators.js"}],"pages/transfer/transfer.helpers.js":[function(require,module,exports) {
"use strict";
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  _transfer2.formValidation.validateField('email', transfer.iban).then(function (result) {
...
(0, _helpers.onUpdateField)('day', function (event) {
  ...
  transfer = _objectSpread(_objectSpread({}, transfer), {}, {
    day: value,
    date: "".concat(year, "-").concat(transfer.month, "-").concat(transfer.value)
  });
...
(0, _helpers.onUpdateField)('month', function (event) {
  ...
  _transfer2.formValidation.validateField('month', transfer.day).then(function (result) {
...
(0, _helpers.onUpdateField)('year', function (event) {
  ...
  _transfer2.formValidation.validateField('year', transfer.day).then(function (result) {
...
(0, _helpers.onSubmitForm)('transfer-button', function () {
  ...
  (0, _transfer.insertTransfer)(transfer).then(function (data) {
    console.log({
      data: data
    });
  });
...
(0, _transfer3.setAccountOptions)(account, params.id);
(0, _transfer.insertTransfer)(transfer).then(function (data) {
  _router.history.back(data);
});
},{"../../common/helpers":"common/helpers/index.js","../../core/router":"core/router/index.js","./transfer.api":"pages/transfer/transfer.api.js","./transfer.validations":"pages/transfer/transfer.validations.js","./transfer.helpers":"pages/transfer/transfer.helpers.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];

...
exports.getMovementList = exports.getAccountMovement = void 0;
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var url = "".concat("http://localhost:3000/api", "/movements");
var urlDos = "".concat("http://localhost:3000/api", "/account-list");
var getMovementList = function getMovementList() {
  return _axios.default.get(url).then(function (_ref) {
    var data = _ref.data;
    return data;
  });
};
exports.getMovementList = getMovementList;
var getAccountMovement = function getAccountMovement(id) {
  return _axios.default.get(urlDos, {
    params: {
      id: id
    }
  }).then(function (_ref2) {
...
exports.getAccountMovement = getAccountMovement;
...
exports.mapMovementListFromApiToViewModel = exports.mapAccountMovementsFromApiToViewModel = void 0;
...
var mapMovementListFromApiToViewModel = function mapMovementListFromApiToViewModel(movementList) {
  return movementList.map(function (movement) {
    return mapMovementFromApiToViewModel(movement);
  });
};
exports.mapMovementListFromApiToViewModel = mapMovementListFromApiToViewModel;
var mapAccountMovementsFromApiToViewModel = function mapAccountMovementsFromApiToViewModel(movement) {
  return {
    id: movement.id,
    iban: movement.iban,
    alias: movement.name,
...
exports.mapAccountMovementsFromApiToViewModel = mapAccountMovementsFromApiToViewModel;
},{"@lemoncode/fonk-iban-validator":"../node_modules/@lemoncode/fonk-iban-validator/dist/@lemoncode/fonk-iban-validator.esm.js"}],"core/router/routes.js":[function(require,module,exports) {
"use strict";
...
(0, _movements.getMovementList)(params.id).then(function (data) {
  var account = (0, _movements3.mapMovementListFromApiToViewModel)(data);
  (0, _movements2.addMovementRows)(account);
});
(0, _movements.getAccountMovement)(params.id).then(function (data) {
  var movement = (0, _movements3.mapAccountMovementsFromApiToViewModel)(data[0]);
  (0, _element.onSetValues)(movement);
});
},{"./movements.api":"pages/movements/movements.api.js","./movements.helpers":"pages/movements/movements.helpers.js","./movements.mappers":"pages/movements/movements.mappers.js","../../core/router":"core/router/index.js","../../common/helpers/element.helpers":"common/helpers/element.helpers.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
